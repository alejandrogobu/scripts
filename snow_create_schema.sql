...
create schema RAW.GOOGLE_SHEETS;

create schema RAW.HEROKU_POSTGRES_EVENTS;

create schema RAW.POSTGRES_PUBLIC;

create or replace TABLE RAW.GOOGLE_SHEETS.BUDGET (
...
create or replace TABLE RAW.HEROKU_POSTGRES_EVENTS.EVENTS (
